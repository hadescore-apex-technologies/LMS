            ...
            courses.map(c => (
              ...
              >
                <div className="min-w-0 flex-1">
                  <span className={`text-[9px] uppercase font-bold tracking-wider block ${selectedCourse?.id === c.id ? 'text-primary font-extrabold' : 'text-muted-foreground'}`}>{c.category_name}</span>
