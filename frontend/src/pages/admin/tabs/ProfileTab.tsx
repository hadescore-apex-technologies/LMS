...
export const ProfileTab: React.FC = () => {
  ...
  return (
    <div className="space-y-6 text-xs max-w-4xl">
      <div>
        <h1 className="text-3xl font-extrabold tracking-tight">Admin Account Profile</h1>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <form 
          ...
          className="p-6 bg-card border border-border rounded-2xl space-y-4 flex flex-col justify-between"
        >
          ...
          <button type="submit" disabled={saveProfileMutation.isPending} className="w-full py-2.5 mt-4 bg-primary text-primary-foreground font-bold rounded-xl shadow-md flex items-center justify-center gap-1.5 font-bold">
            <Save size={12} />
        ...
        >
          ...
          <button type="submit" disabled={updatePasswordMutation.isPending} className="w-full py-2.5 mt-4 bg-primary text-primary-foreground font-bold rounded-xl shadow-md flex items-center justify-center gap-1.5 font-bold">
            <Save size={12} />
